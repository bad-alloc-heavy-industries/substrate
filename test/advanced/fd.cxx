...
TEST_CASE("advanced::fd_t bad fd", "[advanced::fd_t]")
{
	fd_t file{};
	size_t result{};
	REQUIRE(file == -1);
...
TEST_CASE("advanced::fd_t bad open", "[advanced::fd_t]")
{
...
TEST_CASE("advanced::fd_t std::string open", "[advanced::fd_t]")
{
...
TEST_CASE("advanced::fd_t write", "[advanced::fd_t]")
{
...
TEST_CASE("advanced::fd_t seek", "[advanced::fd_t]")
{
...
TEST_CASE("advanced::advanced::fd_t read", "[advanced::fd_t]")
{
	fd_t file{"fd.test", O_RDONLY};
	REQUIRE(file >= 0);
	REQUIRE(file.valid());
